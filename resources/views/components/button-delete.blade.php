...
<el-dialog>
    <dialog id="dialog-{{ $modalId }}" aria-labelledby="dialog-title"
        ...
        <div tabindex="0"
            ...
            <el-dialog-panel
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" command="close" commandfor="dialog-{{ $modalId }}"
                        wire:loading.attr="disabled" wire:click="delete({{ $rowId }})"
