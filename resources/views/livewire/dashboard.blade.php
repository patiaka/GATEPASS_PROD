    ...
    <div class="rounded-2xl p-4 col-span-12 grid grid-cols-12 gap-4 md:gap-6 border shadow-xs">
        ...
        <div class="col-span-12 grid grid-cols-1 gap-4 md:gap-6 xl:grid-cols-4 2xl:grid-cols-5">
            ...
            <a href="{{ route('car.check') }}"
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $car_check_out }}</span>
            </a>
            ...
            <a href="{{ route('material.check') }}"
                ...
                <div class="flex gap-4 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Checked out Material</p>
                    </div>
                </div>
            ...
            <a href="{{ route('car.index') }}"
                ...
                <div class="flex gap-4 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Gate pass Requests</p>
                    </div>
                </div>
                <span class="text-2xl font-semibold text-slate-800">{{ $car_request_all }}</span>
            </a>
            ...
            <a href="{{ route('car.index') }}"
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $car_request_approved }}</span>
            </a>
            ...
            <a href="{{ route('car.pending') }}"
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $car_request_pending }}</span>
            </a>
            ...
            <a href="{{ route('car.index') }}"
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $car_request_rejected }}</span>
            </a>
            ...
            <a href="{{ route('material.index') }}"
                ...
                <div class="flex gap-4 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">material Requests</p>
                    </div>
                </div>
                <span class="text-2xl font-semibold text-slate-800">{{ $mat_request_all }}</span>
            </a>
            <!-- Approved -->
            <a href="{{ route('material.index') }}"
                class="p-4 flex items-center justify-between bg-white border border-gray-200 shadow-xs rounded-2xl">
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $mat_request_approved }}</span>
            </a>
            ...
            <a href="{{ route('material.pending') }}"
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $mat_request_pending }}</span>
            </a>
            ...
            <a href="{{ route('material.index') }}"
                ...
                <span class="text-2xl font-semibold text-slate-800">{{ $mat_request_rejected }}</span>
            </a>
        </div>
    </div>
</div>