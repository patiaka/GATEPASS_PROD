            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6 pb-5 border-b border-gray-100">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-[#0f4b73] tracking-tight leading-tight">Vehicle Check-In / Check-Out</h2>
                            <p class="text-sm text-slate-500">Entry / exit inspection record</p>
                        </div>
                    </div>
                    ...
                    <form wire:submit.prevent="recordSecurityCheck" class="space-y-6">
                        ...
                        @if ($carRequest && $carRequest->somisy_car != 'no_vehicle')
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 mb-2">
                                    Measure <span class="text-red-500">*</span>
                                </label>

                                <div class="grid grid-cols-2 gap-3">
                                    @foreach (['Kilometers', 'Per hours'] as $g)
                                        <label class="{{ $radioCard }}">
                                            <input type="radio" wire:model.live="Kilometers_type" value="{{ $g }}" class="sr-only">
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="kilometers" min="0"
                                    placeholder="{{ $Kilometers_type === 'Per hours' ? 'Enter hours' : 'Enter kilometers' }}"
                                    class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-4 gap-3">
                                    @foreach (['25%', '50%', '75%', '100%'] as $f)
                                        <label class="{{ $radioCard }}">
                                            <input type="radio" wire:model="fuel_level" value="{{ $f }}" class="sr-only">
                                            <span class="font-semibold text-slate-700">{{ $f }}</span>
                                        </label>
                                    @endforeach
                                </div>
