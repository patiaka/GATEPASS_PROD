<div>
    <div class="flex justify-between items-center border-b border-gray-200 pb-6">
        <h1 class="text-2xl font-bold text-[#0e3a61] tracking-tight">{{ __('Material Off Site Request Form') }}</h1>
        ...
        <div class="p-6">
            <form wire:submit.prevent="save" class="space-y-6"
                ...
                <div class="w-full">
                            ...
                            <div class="grid grid-cols-12 gap-4 mb-3 items-start">
                                ...
                                <div class="col-span-3">
                                    <label for="serial_number"
                                        class="block text-sm font-medium text-gray-700 mb-1">{{ __('Additional info') }}
                                    </label>
                    ...
                    <!-- Images upload -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('Request document (images)') }} <span class="text-red-500">*</span></label>
